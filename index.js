...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'fd2d06a4d3msh9163664d96357aap1e6f8fjsn56a9cc5fea8c',
...
// ===========================
// dummy data to comment out late (start)
// ===========================
...
// for loops are used to do repetitive tasks, in this case, to print out each individual element in the graphData array and their respective properties.
for (let i = 0; i < 25; i++) {
		graphData.push(
				{
...
// This allows us to reutrn only the name of the twitter trend object.
